    ...
    <>
      ...
      {!latestResult ? (
        <div className="bg-white border border-slate-100 rounded-3xl p-12 text-center flex flex-col items-center justify-center min-h-[400px] shadow-sm">
          ...
          <Link 
            href="/kuis"
            className="flex items-center justify-center gap-2 bg-orange-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-orange-600 transition-all hover:scale-105 shadow-xl shadow-orange-500/20 w-fit mx-auto"
          >
        ...
        <div id="dashboard-pdf-content" className="grid grid-cols-1 xl:grid-cols-12 gap-6 print:grid-cols-12 print:gap-4 print:text-sm">
          ...
          <div id="hasil-riasec" className="xl:col-span-9 flex flex-col gap-6 scroll-mt-24 print:col-span-9 print:gap-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 print:grid-cols-5 print:gap-4">
              ...
              {/* Skor Minat (Span 3) */}
              <div className="lg:col-span-3 bg-white rounded-3xl p-6 md:p-8 border border-slate-100 shadow-sm print:col-span-3 print:p-4 print:break-inside-avoid">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    { label: 'Bisnis & Manajemen', icon: <Briefcase size={16}/>, color: 'bg-orange-500', bg: 'bg-orange-100', text: 'text-orange-600', score: latestResult.ai_recommendation?.industry_scores?.bisnis || 0 },
              ...
              <div className="lg:col-span-2 bg-white rounded-3xl p-6 md:p-8 border border-slate-100 shadow-sm flex flex-col print:col-span-2 print:p-4 print:break-inside-avoid">
                ...
                <div className="space-y-3 flex-1">
                  {(latestResult.ai_recommendation?.recommended_majors || []).map((major: any, idx: number) => (
                    <div key={idx} className="flex items-center gap-4 bg-purple-50/50 p-3 rounded-xl border border-purple-100/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-9 gap-6 print:grid-cols-9 print:gap-4">
              ...
              <div className="lg:col-span-3 bg-white rounded-3xl p-6 border border-slate-100 shadow-sm flex flex-col print:col-span-3 print:p-4 print:break-inside-avoid">
                <div className="flex items-center gap-3 mb-2">
            ...
            <div className="bg-gradient-to-r from-[#f0ebf8] to-[#f8f5fc] rounded-3xl p-6 md:p-8 border border-purple-100 flex flex-col md:flex-row items-center justify-between gap-8 overflow-hidden relative shadow-sm print:p-4 print:break-inside-avoid">
