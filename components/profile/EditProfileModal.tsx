  ...
  return (
    <>
      <button 
        ...
        className="absolute top-4 right-4 p-2 text-slate-400 hover:text-purple-600 hover:bg-purple-50 rounded-full transition-colors"
        title="Edit Profil"
      >
        <Edit3 size={18} />
      </button>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-3xl p-6 md:p-8 shadow-2xl z-50 border border-slate-100"
            >
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <button 
                  type="submit"
                  disabled={isLoading}
                  className="w-full mt-6 flex items-center justify-center gap-2 bg-purple-600 text-white px-6 py-3.5 rounded-xl font-bold hover:bg-purple-700 transition-all shadow-md shadow-purple-200 disabled:opacity-70 disabled:cursor-not-allowed"
                >
